...
module.exports = { session: process.env.SESSION_ID || 'Gifted;;;',
    ...
    OWNER_NAME: process.env.OWNER_NAME || "✪⏤͟͞★⃝ꪶ‎𝐐ᴜᴇᴇɴ-𝐒ɪʏᴀ-𖥘✪͜͡➺",
    NUMERO_OWNER : process.env.OWNER_NUMBER || "918653805156,916290260741", 
             
    AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "yes",
AUTOREAD_MESSAGES: process.env.AUTO_READ_MESSAGES || "no",
CHATBOT: process.env.CHAT_BOT || "no",
    AUTO_DOWNLOAD_STATUS: process.env.AUTO_DOWNLOAD_STATUS || 'no',
    BOT : process.env.BOT_NAME || '[ !! < 𝐄ᴠɪʟ-𝐒ɪʏᴀ > !! ]',
